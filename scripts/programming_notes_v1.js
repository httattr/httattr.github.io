...
function init() {
   // Print Header
   document.getElementById("header").innerHTML = '<p>hope this is a useful blog &nbsp;&nbsp;| &nbsp;&nbsp;<a href="../index.html">HOME</a></p>';

   // Print Footer
   document.getElementById("footer").innerHTML = '<p>Feedback, comments, corrections, and errata can be sent to [TBC]. &nbsp;&nbsp;|&nbsp;&nbsp;<a href="#wrap-outer">TOP</a><br />Website template cr: Prof Chua\'s <a href="https://www3.ntu.edu.sg/home/ehchua/programming/index.html" >yet another insignificant Programming Notes</a></p>';
